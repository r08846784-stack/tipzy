...
import { fetchuser, fetchpayments, initiate } from '@/actions/useractions' //fetchuser, fetchpayments,
    ...
    return (
        <>
           <ToastContainer
            ...
            <div className="info flex justify-center items-center my-24 mb-32 bg-slate-950 flex-col gap-2">
